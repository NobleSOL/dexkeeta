                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {wallet.isKeythings && (
                          <div className="flex items-center gap-1 mt-1">
                            ...
                            <span className="text-xs text-green-400 font-medium">Keythings</span>
                          </div>
                        )}
                      </div>
                    </div>
                ...
                <CardContent>
                  <div className="space-y-2">
                    {displayedTokens.map((token) => (
                      <div
                        key={token.address}
                        className="group relative rounded-xl border border-border/40 bg-gradient-to-br from-secondary/40 to-secondary/20 p-3 transition-all hover:border-brand/40 hover:shadow-lg hover:shadow-brand/5"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            {/* Token Icon */}
                            {token.symbol === "KTA" ? (
                              <div className="flex h-8 w-8 items-center justify-center rounded-full overflow-hidden bg-gradient-to-br from-brand/20 to-brand/10">
                                <img
                              ...
                              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-brand/20 to-brand/10 text-xs font-bold text-brand">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div className="text-right">
                              <div className="text-sm font-bold">{token.balanceFormatted}</div>
                              {tokenPrices?.[token.address]?.priceUsd && (
                                <div className="text-xs text-muted-foreground">
                                  ${(parseFloat(token.balanceFormatted) * tokenPrices[token.address].priceUsd!).toFixed(2)}
                                </div>
                              )}
                            </div>
                          </div>
                    ...
                    {sortedTokens.length > 5 && (
                      ...
                      >
                        {showAllTokens ? (
                          ...
                          <span>Show {sortedTokens.length - 5} More</span>
                        )}
                      </Button>
                    )}
                  </div>
