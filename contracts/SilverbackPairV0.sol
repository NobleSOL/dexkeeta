...
contract SilverbackPairV0 is ISilverbackPair {
    ...
    uint256 public kLast; // reserve0 * reserve1, for protocol fee tracking
    ...
    /// @notice Mint protocol fee if enabled (1/6 of swap fees)
    /// @dev Called before mint/burn to capture fee on reserve growth
    function _mintFee(uint112 _reserve0, uint112 _reserve1) private returns (bool feeOn) {
        address feeTo = ISilverbackFactory(factory).feeTo();
