...
import { SilverbackPairV1 } from "./SilverbackPairV1.sol";

library SilverbackLibraryV1 {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        bytes32 hash = keccak256(
            abi.encodePacked(bytes1(0xff), factory, salt, keccak256(type(SilverbackPairV1).creationCode))
        );
